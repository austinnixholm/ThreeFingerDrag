...
public:
	TouchDownEventArgs(std::chrono::time_point<std::chrono::steady_clock> time, TouchInputData* data) : TouchActivityEventArgs{ time, data } {}
};

class TouchUpEventArgs : public TouchActivityEventArgs {
public:
	TouchUpEventArgs(std::chrono::time_point<std::chrono::steady_clock> time, TouchInputData* data) : TouchActivityEventArgs{ time, data } {}
};